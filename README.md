...
[课程设计报告](课程设计报告.md) | [项目要求](docs/项目要求.md) | [架构设计](docs/架构设计文档.md) | [论文理解](docs/论文理解与借鉴.md)
...
本系统设计了**三阶段对比实验**，用于全面分析自进化现象和防御效果。

#### 阶段一：基线测试（Baseline Test）

**目的**：验证智能体在**正常情况下**的合规性
...
- [测试框架说明](tests/README.md) - 测试框架使用指南
...
- [Streamlit](https://streamlit.io/) - 快速构建数据应用的Python框架
- [阿里云通义千问](https://tongyi.aliyun.com/) - 大语言模型API服务

---

## 📧 联系方式

- 项目 Issues: [GitHub Issues](https://github.com/Maruiful/Agent_Misevolution_Safety/issues)
